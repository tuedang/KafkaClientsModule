...
class ConsumerExecutor {
    ...
    ConsumerExecutor(String topic, String groupId, Observer<ConsumerRecord<String, ?>> observer, Class consumerClass,
    ...
    void start() {
        if (!isRunning()) {
            ...
            KafkaConsumer<String, ?> kafkaConsumer = new KafkaConsumer(consumerProperties, new StringDeserializer(), new StringDeserializer());
